        ...
        <div class="register_box">
            <el-form ref="register" :model="registerForm" class="elform">
                ...
                <el-form-item class="elform1">
                    <el-input v-model="registerForm.id" id="id" type="text" placeholder="id" auto-complete="off"></el-input>
                </el-form-item>
                ...
                <el-form-item>
                    <el-button style="margin-left:100px;margin-top: 50px;" class="btn-all" size="medium" type="primary"
                        @click="toaccountLogin">登录</el-button>
                    <el-button class="btn-all" size="medium" type="primary" @click="accountregister">注册</el-button>
                </el-form-item>
            </el-form>
        </div>
...
export default {
    ...
    methods: {
        ...
        accountregister() {
            ...
            apiService.register(this.registerForm).then((res) => {
